...
public class CoordinatorMenu extends FrameLayout {
    ...
    //距离右侧的长度
    private static final int MENU_MARGIN_RIGHT = 84;
    ...
    public CoordinatorMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //Log.e("what","mScreenWidth："+mScreenWidth+"----"+"density："+density+"-----"+"mMenuWidth："+mMenuWidth);
    ...
    public interface OnMenuChangeListener{
        void menuChange(boolean isOpen);
    }
