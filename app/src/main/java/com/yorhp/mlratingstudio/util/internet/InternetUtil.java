package com.yorhp.mlratingstudio.util.internet;
...
public class InternetUtil {
    ...
    public static boolean isOnline() {
        ConnectivityManager con = (ConnectivityManager) MlApplication.getAppContext().getSystemService(Activity.CONNECTIVITY_SERVICE);
